...
use dashmap::DashMap;
use kcl_language_server::chumsky::{parse, type_inference, Func, ImCompleteSemanticToken, Spanned};
use kcl_language_server::completion::completion;
use kcl_language_server::jump_definition::{get_definition, get_definition_of_expr};
use kcl_language_server::reference::get_reference;
...
impl LanguageServer for Backend {
    ...
    //             match item {
    //                 kcl_language_server::completion::ImCompleteCompletionItem::Variable(var) => {
    ...
    //                     });
    //                 }
    //                 kcl_language_server::completion::ImCompleteCompletionItem::Function(
    //                     name,
    //                     args,
    //                 ) => {
    //                     ret.push(CompletionItem {
